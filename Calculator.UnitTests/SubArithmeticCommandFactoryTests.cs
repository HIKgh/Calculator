...
public class SubArithmeticCommandFactoryTests
{
    ...
    private IArithmeticCommandFactory<SubArithmeticCommand> _factory = null!;

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        _factory = new SubArithmeticCommandFactory(_arithmeticModuleMock.Object);
    }
    ...
    public void CreateTest()
    {
        ...
        command.Should().BeOfType(typeof(SubArithmeticCommand));
    }
}